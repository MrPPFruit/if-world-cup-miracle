...
Define the static deployment and first-version CDN-log telemetry constraints for the World Cup IF mini-game, keeping the app backend-free, low-cost, and safe for Tencent Cloud COS/CDN delivery.
